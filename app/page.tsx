      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-40 -mt-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-lg hover:bg-black 
              ...
              <div className="p-6">
                ...
                <p className="">
                  State-of-the-art AI technology to create high-quality,
                  unique content tailored to your needs.
                </p>
              </div>
            </div>
            {/* Fast Response */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Generate blog posts in seconds, saving you time and
